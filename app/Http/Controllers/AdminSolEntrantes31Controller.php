<?php namespace App\Http\Controllers;
	...
	class AdminSolEntrantes31Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Apellido y nombre','name'=>'apeynombre','type'=>'datamodal','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datamodal_table'=>'afiliados','datamodal_columns'=>'apeynombres,documento,nroAfiliado','datamodal_size'=>'large'];
			$this->form[] = ['label'=>'Número de solicitud','name'=>'aposid','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','readonly'=>'true','value'=>'APOS'.date('YmdHis')];
			$this->form[] = ['label'=>'Artículos','name'=>'articulos','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Cantidad','name'=>'cantidad','type'=>'number','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Clínica','name'=>'clinica','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'clinicas,nombre'];
			$this->form[] = ['label'=>'Estado','name'=>'estado','type'=>'select2','datatables'=>'estados,estado','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'estados,estado','value'=>'1', 'disabled'=>'disabled'];
			$this->form[] = ['label'=>'Fecha Cirugia','name'=>'fecha_cirugia','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Médico','name'=>'medico','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'medicos,nombremedico'];
			...
			$this->form[] = ['label'=>'Observación','name'=>'observacion','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Clínica','name'=>'clinica','type'=>'select2','datatable'=>'clinicas,nombre','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Estado','name'=>'estado','type'=>'select','validation'=>'required','width'=>'col-sm-10','datatable'=>'estados,estado','disabled'=>'disabled', 'value'=>'1'];
			//$this->form[] = ['label'=>'Fecha Cirugia','name'=>'fecha_cirugia','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Médico','name'=>'medico','type'=>'select2','datatable'=>'medicos,nombremedico','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Necesidad','name'=>'necesidad','type'=>'select2','datatable'=>'necesidads,necesidad','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'necesidads,necesidad'];
			//$this->form[] = ['label'=>'Observación','name'=>'observacion','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			# OLD END FORM
	        ...
	        */
			...
			//$this->sub_module[] = ['label'=>'Cotizar','path'=>'cotizacions','parent_columns'=>'aposid,articulos,estado,fecha_cirugia,observacion','foreign_key'=>'aposid','button_color'=>'success','button_icon'=>'fa fa-bars'];
