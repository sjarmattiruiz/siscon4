<?php namespace App\Http\Controllers;
	...
	class AdminAdjudicacionsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "adjudicacions";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Apeynombre","name"=>"apeynombre","join"=>"afiliados,apeynombres"];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Apeynombre","name"=>"apeynombre","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Aposid","name"=>"aposid","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Articulos","name"=>"articulos","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Clinica","name"=>"clinica","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Medico","name"=>"medico","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
