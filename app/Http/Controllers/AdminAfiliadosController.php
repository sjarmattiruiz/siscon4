<?php namespace App\Http\Controllers;
	...
	class AdminAfiliadosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Apellido y nombres","name"=>"apeynombres"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Apellido y nombre','name'=>'apeynombres','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
